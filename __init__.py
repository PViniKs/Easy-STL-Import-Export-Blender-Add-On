bl_info = {
    "name": "Easy STL Import/Export",
    "author": "Guillaume Bouchard (Guillaum), Paulo Vinícius Kuss (Pviniks)",
    "version": (1, 1, 3),
    "blender": (2, 81, 6),
...
"""
    THIS ADD-ON IS A MODIFIED VERSION OF THE ORIGINAL STL IMPORT/EXPORT ADD-ON THAT COMES WITH BLENDER.
...
def register():
    ...
    # THE FOLLOWING CODE WAS ADDED TO THE ORIGINAL ADDON
    wm = bpy.context.window_manager
    km = wm.keyconfigs.addon.keymaps.new(name="Object Mode", space_type='EMPTY')

    kmi_import = km.keymap_items.new(ImportSTL.bl_idname, 'I', 'PRESS', ctrl=True)
    kmi_export = km.keymap_items.new(ExportSTL.bl_idname, 'E', 'PRESS', ctrl=True)

    addon_keymaps.append((km, kmi_import))
    addon_keymaps.append((km, kmi_export))
...
# ALSO ADDED TO THE ORIGINAL ADDON
addon_keymaps = []
